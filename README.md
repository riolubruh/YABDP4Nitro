...
The project went under the name NitroPerks at the time.
...
The name was changed and made intentionally bad to distance it from the original NitroPerks and any of its forks.
