...
declare global {
    ...
    namespace BdApiTypes {
        ...
        type ModuleFilter = (exports: ModuleExports, module?: WebpackModule, moduleId?: number | string) => boolean;
        ...
        interface Webpack {
            ...
            getWithKey<T = any>(filter: ModuleFilter, options?: BaseModuleOptions): [T | undefined, string | undefined];
            ...
            waitForModule<T = any>(filter: ModuleFilter, options?: WaitForModuleOptions): Promise<T | undefined>;
            ...
            getByPrototypeKeys<T = any>(...args: [...props: string[], options?: GetModuleOptions]): T | undefined;
            getAllByPrototypeKeys<T = any>(...args: [...props: string[], options?: GetAllModulesOptions]): T[];
            ...
            getByStrings<T = any>(...args: [...strings: string[], options?: GetModuleOptions]): T | undefined;
            getAllByStrings<T = any>(...args: [...strings: string[], options?: GetAllModulesOptions]): T[];

            getBySource<T = any>(...args: [...searches: (string | RegExp)[], options?: GetModuleOptions]): T | undefined;
            getAllBySource<T = any>(...args: [...searches: (string | RegExp)[], options?: GetAllModulesOptions]): T[];
        ...
        interface Net {
            fetch(input: RequestInfo | URL, init?: RequestInit & { timeout?: number | null }): Promise<Response>;
        }
        ...
        interface NodePatcherInstance {
            patch(node: { type: any }, callback: (props: any, node: React.ReactNode, instance?: any) => React.ReactNode | void): void;
            destroy(): void;
        }
        ...
        interface ReactUtils {
            ...
            wrapInHooks<T extends Function>(functionComponent: T, customPatches?: Record<string, Function>): T;
        ...
        interface UI {
            ...
            showNotice(content: React.ReactNode, options?: NoticeOptions): ((immediately?: boolean) => void) | undefined;
        ...
        interface Utils {
            findInTree(tree: any, searchFilter: string | ((node: any) => boolean), options?: FindInTreeOptions): any;
