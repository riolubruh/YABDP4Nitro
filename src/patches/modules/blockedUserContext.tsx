...
export default {
    ...
    ids: undefined,
    waitFor: [USER_SETTINGS_FILTER, BetterDiscord.Webpack.Filters.bySource('isGroupDM', 'targetIsUser')], // filters to wait for.
    apply(finale, patcher) {
        ...
        patcher.after(mod?.module, mod?.key, (_,[args],ret) => {
            ...
            const channel = SelectedChannelStore.getLastSelectedChannelId() ? ChannelStore.getChannel(SelectedChannelStore.getLastSelectedChannelId()) : ChannelStore.getSortedPrivateChannels()?.[0];
